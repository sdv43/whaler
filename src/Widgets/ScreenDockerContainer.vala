...
class Widgets.ScreenDockerContainer : Gtk.Box {
    ...
    public ScreenDockerContainer () {
        ...
        this.pack_start (new Screens.DockerContainer.SideBar (), false);
    ...
    private Gtk.Widget build_log_output () {
        ...
        box.pack_start (new Screens.DockerContainer.TopBar (), false);
        box.pack_end (new Screens.DockerContainer.Log (), true, true);
